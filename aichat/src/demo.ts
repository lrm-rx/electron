...
export async function run3() {
  const imageBuffer = await readFile('/Users/ming/Desktop/dog.jpeg')
...
export async function run4() {
  const fileObj = await client.files.create({ file: fs.createReadStream('/Users/ming/Desktop/1.pdf'), purpose: 'file-extract' as any })
